...
class AlexaHandlerTest {
     ...
     */
    @Test
    fun testHandleInvalidRequest() = runBlocking {
     ...
     */
    @Test
    fun testHandleAuthorizationRequest() = runBlocking {
     ...
     */
    @Test
    fun testHandleDiscoveryRequest() = runBlocking {
     ...
     */
    @Test
    fun testHandlePowerControllerRequest() = runBlocking {
     ...
     */
    @Test
    fun testHandlePercentageControllerRequest() = runBlocking {
     ...
     */
    @Test
    fun testHandleThermostatControllerRequest() = runBlocking {
