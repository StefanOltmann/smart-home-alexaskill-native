...
object AlexaHandler : LambdaBufferedHandler<String, String> {
    ...
    override suspend fun handleRequest(
        ...
        val responseJson = handleRequestJson(input, restApi)
     ...
     */
    suspend fun handleRequestJson(requestJson: String, restApi: RestApi): String {
    ...
    private suspend fun handleRequestObject(
        ...
        return when (directive.header.namespace) {
             ...
             */
            Header.NAMESPACE_DISCOVERY -> createDeviceDiscoveryResponse(restApi)
            ...
            Header.NAMESPACE_POWER_CONTROLLER ->
                executePowerControllerDirectiveAndCreateResponse(directive, restApi)
            ...
            Header.NAMESPACE_PERCENTAGE_CONTROLLER ->
                executePercentageControllerDirectiveAndCreateResponse(directive, restApi)
            ...
            Header.NAMESPACE_THERMOSTAT_CONTROLLER ->
                executeThermostatControllerDirectiveAndCreateResponse(directive, restApi)
    ...
    private suspend fun createDeviceDiscoveryResponse(
        ...
        val devices = try {
            ...
            Log.info("Error fetching devices: $ex")
         ...
         */
        if (!unitTesting)
            Log.info("Devices from API: $devices")
    ...
    private suspend fun executeThermostatControllerDirectiveAndCreateResponse(
        ...
        val callWasSuccessful =
            executeTargetTemperatureCall(endpointId, targetTemperature, restApi)
    ...
    private suspend fun executePowerStateCall(
        ...
        try {
            ...
            Log.info("Error setting power state: $ex")
    ...
    private suspend fun executePercentageCall(
        ...
        try {
            ...
            Log.info("Error setting percentage: $ex")
    ...
    /**
     * Calls the backend API to set the target temperature of a specified endpoint.
     */
    private suspend fun executeTargetTemperatureCall(
        ...
        try {
            ...
            Log.info("Error setting target temperature: $ex")
